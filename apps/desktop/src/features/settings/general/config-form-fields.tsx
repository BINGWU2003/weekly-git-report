      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <Select
              value={sinceMode}
              onValueChange={(value) => field.onChange(value === 'last-monday' ? 'last monday' : today())}
            >
      ...
      {compact ? (
              ...
              <CollapsibleTrigger asChild>
                <Button type='button' variant='ghost' className='h-auto w-full justify-between p-0 text-start'>
                  <span>
                    ...
                    <CardDescription className='mt-1.5'>缓存目录、默认周期和无提交仓库规则。</CardDescription>
                  </span>
        ...
        <>
          <Card>
            ...
            <CardContent>{periodFields}</CardContent>
          </Card>
          <Card>
